...
function buildPurchaseWizard(form){
  ...
  const refreshStandard=()=>{standardCards.forEach(({render})=>render(purchaseQualityStandard(form)));window.refreshPurchaseQcParameters?.(form);};
