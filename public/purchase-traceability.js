...
openModal=(type,pid)=>{
  ...
  if(createdByField){
    ...
    createdByField.innerHTML=`<label>Created by</label><input name="createdBy" value="${escapeValue(operator?.name||'Current user')}" readonly>`;
  }
