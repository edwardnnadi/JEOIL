...
function buildGoodsInwardsWizard(form,receipt){
  ...
  exemptNote.innerHTML='<strong>No quality check required</strong><span>This purchase item is configured as QC-exempt in Administration → Purchase Items. Controlled items must complete the factory inspection before warehouse release.</span>';
