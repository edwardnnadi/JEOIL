...
const linkedPurchaseFields=['purchaseId','purchaseReference','purchaseDate','purchaseStatus','item','supplier','category','orderedQty','unit','unitPrice','cost','purchasedById','purchasedBy','createdBy','createdAt','batchNumber','lotNo','originState','originLga','collectionSite','originCode','supplierReceiptId','purchaseQuality','attachments'];
