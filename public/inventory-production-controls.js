...
(function () {
  ...
  function activeRunBanner() {
    ...
    banner.innerHTML = `<strong>${esc(run.batch)} is running</strong><span id="production-elapsed"></span><button class="secondary" id="end-production-run">End production run</button>`;
